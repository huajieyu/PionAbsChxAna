...
// Thu Dec 17 08:55:10 2020 by ROOT version 6.18/04
// from TTree beamana/beam analysis tree
// found on file: /dune/data/users/fstocker/ANALYSIS/prod4_files/pionana_Prod4_mc_1GeV_12_16_20.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<vector<double> > *reco_beam_calo_IDE_Zs;
   ...
   TBranch        *b_reco_beam_calo_IDE_Zs;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/dune/data/users/fstocker/ANALYSIS/prod4_files/pionana_Prod4_mc_1GeV_12_16_20.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/dune/data/users/fstocker/ANALYSIS/prod4_files/pionana_Prod4_mc_1GeV_12_16_20.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/dune/data/users/fstocker/ANALYSIS/prod4_files/pionana_Prod4_mc_1GeV_12_16_20.root:/pionana");
...
void UBXSecEvent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("reco_beam_calo_IDE_Zs", &reco_beam_calo_IDE_Zs, &b_reco_beam_calo_IDE_Zs);
