...
void plot_reso(){
  ...
  TH1D *h_Evttot_mc = (TH1D*)input1->Get("h_Evttot");
  TH1D *h_Evttot_data = (TH1D*)input0->Get("h_Evttot");
  ...
  std::cout<<"norm_fac is "<<norm_fac<<std::endl; 
  TH1D *htotinc_reco_beamz;
  htotinc_reco_beamz = (TH1D*)input1->Get("htotinc_reco_beamz");
  TH1D *htotinc_reco_beamwire;
  htotinc_reco_beamwire = (TH1D*)input1->Get("htotinc_reco_beamwire");
  

  TH1D *htotinc_reco_beamz_reso;
  htotinc_reco_beamz_reso = (TH1D*)input1->Get("htotinc_reco_beamz_reso");
 
  TH1D *htotinc_reco_beamwire_reso;
  htotinc_reco_beamwire_reso = (TH1D*)input1->Get("htotinc_reco_beamwire_reso");

  
  TH1D* htotinc_true_beam_trajz[25];
  for(int i=0; i<25; i++){
       htotinc_true_beam_trajz[i] = (TH1D*)input1->Get(Form("htotinc_true_beam_trajz_%d",i));
  }
  TH1D* htotinc_reco_beam_endz[25];
  for(int i=0; i<25; i++){
       htotinc_reco_beam_endz[i] = (TH1D*)input1->Get(Form("htotinc_reco_beam_endz_%d",i));
  }
  ...
  for(int i=0; i<25; i++){
       hgen_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hgen_reco_beam_incidentEnergy_%d",i));
  }
  TH1D* hsel_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hsel_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hsel_reco_beam_incidentEnergy_%d",i));
  }
  std::cout<<"libo test 0"<<std::endl;
  TH1D* hsig_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hsig_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hsig_reco_beam_incidentEnergy_%d",i));
  }
  TH1D* hchxbac_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hchxbac_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hchxbac_reco_beam_incidentEnergy_%d",i));
  }
  TH1D* hreabac_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hreabac_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hreabac_reco_beam_incidentEnergy_%d",i));
  }
  TH1D* hotherbac_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hotherbac_reco_beam_incidentEnergy[i] = (TH1D*)input1->Get(Form("hotherbac_reco_beam_incidentEnergy_%d",i));
  }
  ...
  for(int i=0; i<25; i++){
       htotinc_data_reco_beam_incidentEnergy[i] = (TH1D*)input0->Get(Form("htotinc_reco_beam_incidentEnergy_%d",i));
  }

  TH1D* htotinc_data_reco_beam_sliceThickness[25];
  for(int i=0; i<25; i++){
       htotinc_data_reco_beam_sliceThickness[i] = (TH1D*)input0->Get(Form("htotinc_reco_beam_sliceThickness_%d",i));
  }


  TH1D* hsel_data_reco_beam_incidentEnergy[25];
  for(int i=0; i<25; i++){
       hsel_data_reco_beam_incidentEnergy[i] = (TH1D*)input0->Get(Form("hsel_reco_beam_incidentEnergy_%d",i));
  }

  std::cout<<"got all the histograms needed to make plots"<<std::endl;
  ...
  for(int i=0; i<sizeof(slicebins)/sizeof(slicebins[0]); i++){
          slicebins[i]=20*i;
  }
  TLine *tlmin;
  TLine *tlmax;
  ...
  for(int i=0; i<25; i++){
   ...
   TGraph *gr1=new TGraph(25, sliceID, N_incident);
   ...
   TGraph *gr2=new TGraph(25, sliceID, N_interact);
   ...
   TGraph *gr3=new TGraph(25, sliceID, N_background);
   ...
   TGraph *gr7=new TGraph(25, sliceID, sliceeff);
